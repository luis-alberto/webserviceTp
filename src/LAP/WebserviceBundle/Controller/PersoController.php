...
class PersoController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('LAPWebserviceBundle:Perso')->findAll();
     ...
     * @Method("POST")
     * @Template("LAPWebserviceBundle:Perso:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('LAPWebserviceBundle:Perso')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("LAPWebserviceBundle:Perso:edit.html.twig")
     */
