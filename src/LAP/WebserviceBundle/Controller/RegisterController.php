...
class RegisterController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('LAPWebserviceBundle:Register')->findAll();
     ...
     * @Method("POST")
     * @Template("LAPWebserviceBundle:Register:new.html.twig")
     */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('LAPWebserviceBundle:Register')->find($id);
    ...
    */
     ...
     * @Method("PUT")
     * @Template("LAPWebserviceBundle:Register:edit.html.twig")
     */
